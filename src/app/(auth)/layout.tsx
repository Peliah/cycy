	...
	return (
		<div
			className={cn(
				figtree.variable,
				fraunces.variable,
				"min-h-screen font-[family-name:var(--font-figtree)] antialiased",
			)}
		>
			<div className="grid min-h-screen lg:grid-cols-2">
				...
				{/* Auth form column */}
				<main className="flex flex-col justify-center bg-[#F4F8F7] px-6 py-12 sm:px-10 lg:px-16">
					<div className="mx-auto w-full max-w-[400px]">
						<div className="mb-8 lg:hidden">
							...
							<p className="text-sm text-[#5C6B69]">
								Create or join a study group and learn together with AI.
							</p>
						</div>
						{children}
					</div>
